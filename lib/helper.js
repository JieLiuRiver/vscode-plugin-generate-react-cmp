const {
  ...
  TS_Ant_Modal_Component,
  JS_Base_Component,
  JS_Lazy_Component,
  JS_ForwardRef_Component,
  JS_Ant_Modal_Component,
} = require("./constants")
...
const getTemplateByType = (type) => {
  switch (type) {
    ...
    case TS_Ant_Modal_Component:
      return templates.TsAntModalCmp
    ...
    case JS_Ant_Modal_Component:
      return templates.JsAntModalCmp
    default:
      return templates.TsBaseCmp
  }
}

const getCustomTemplatePath = () =>
  vscode.workspace.getConfiguration().get("customTemplatePath")
